...
./ NUMBER NEW1=10,INCR=10
MVSRES,0,1,3350    ,Y        SYSTEM RESIDENCE (PUBLIC)
MVS000,0,1,3350    ,Y        SYSTEM DATASETS (PUBLIC)
PAGE00,0,1,3350    ,Y        PAGE DATASETS (PUBLIC)
PUB000,1,1,3380    ,N        PUBLIC DATASETS (PUBLIC)
PUB001,1,1,3390    ,N        PUBLIC DATASETS (PUBLIC)
SMP000,1,1,3350    ,N        DISTRIBUTION LIBRARIES (PUBLIC)
...
SPOOL1,0,1,3350    ,Y        JES2 QUEUES (PUBLIC)
SYSCPK,1,1,3350    ,N        COMPILER/TOOLS (PUBLIC)

//SLB0001  JOB (SYSGEN),'USERMOD: SLB0001',
//             CLASS=A,
//             MSGCLASS=A,
//             MSGLEVEL=(1,1),
//             REGION=4096K
...
//* exit IKJEFF53 (source: Greg Price/CBT file #134) to validity      *
//* check JOBNAME on a CANCEL, OUTPUT, or STATUS TSO command.         *
//*********************************************************************
//*
//BUPDTE01 EXEC PGM=IEBUPDTE,PARM=NEW
//SYSPRINT DD  DUMMY
//SYSUT2   DD  DISP=SHR,DSN=SYS1.UMODSRC
//SYSIN    DD  *
./ ADD NAME=IKJEFF53
IKJEFF53 TITLE 'MVS CUSTOM-BUILT IPO SUPPLIED FIB INSTALLATION EXIT    C
                        '                                               
*/*                                                                     
...
*                   THE EXIT ISSUES A RETURN CODE REJECTING THE       * 
*                   JOBNAME.                                          * 
*                   CHANGED BY GREG PRICE OF FERNTREE TO ALLOW    GIP * 
*                   CANCEL OF JOBS WITH NAMES EQUAL TO THE TSO    GIP * 
*                   USERID.  JES WILL NOT ALLOW THE CANCELLING    GIP * 
*                   OF EXECUTING STARTED TASKS AND TSO SESSIONS,  GIP * 
*                   BUT A GENERAL TSO USER WILL BE ABLE TO PURGE  GIP * 
*                   SYSOUT FROM PRIOR TSO SESSIONS WHICH ARE      GIP * 
*                   NOT YET ON A PRINT/PUNCH DEVICE.              GIP * 
*                                                                     * 
*              NOTES =                                                * 
*                                                                     * 
...
*                                      REGISTER 14 AND LOAD             
         ...
         CH    R14,0(,R6)              SEE IF USERID LENGTH IS      GIP 
*                                      LONGER THAN JOBNAME LENGTH   GIP 
         BH    BADJOBN                 YES....GO BUILD INVALID      GIP 
*                                      JOBNAME MESSAGE              CUJ 
...
*********************************************************************** 
*                                                                     * 
*        SAME MESSAGE TEXTS FOR CANCEL AND OUTPUT               GIP   * 
*                                                                     * 
*********************************************************************** 
         SPACE 2                                                        
...
SIZDATD  DC    AL1(0)                                                   
         DC    AL3(ENDDATD-DATD)                                        
*EJTEXT1 DC    CL66'REJECTED - JOBNAME MUST BE YOUR USERID PLUS AT LEAS 
*              T ONE CHARACTER'                                     GIP 
